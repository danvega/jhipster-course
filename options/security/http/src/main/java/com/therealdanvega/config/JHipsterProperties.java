...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "HttpDemo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "HttpDemo API";

        private String description = "HttpDemo API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "HttpDemo";
